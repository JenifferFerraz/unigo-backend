...
export class UpdateUserAndStudentProfile1745030244386 implements MigrationInterface {
    name = 'UpdateUserAndStudentProfile1745030244386'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" ADD "termsAccepted" boolean NOT NULL DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "student_profiles" DROP COLUMN "documentId"`);
    }
